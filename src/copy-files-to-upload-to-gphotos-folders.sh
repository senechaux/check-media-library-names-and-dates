...
for folder in "${folders[@]}"; do
  time python3 copy-files-to-upload-to-gphotos.py --source "/users/angel/Insync/ladirecciondeangel@gmail.com/Google Drive/Fotitos/$folder/" --destiny "/users/angel/Fotitos_compressed_to_upload_to_gphotos/$folder/" --copy_images
  # --copy_videos --video_preset veryfast480p
done
